# Vendored from wzhouxiff/RestoreFormerPlusPlus (Apache 2.0, see NOTICE).
# Patched: added face_model_rootpath so facexlib loads bundled local weights
# instead of downloading them at runtime (PicMedic ships offline).
import os
...
class RestoreFormer():
    ...
    def __init__(self, model_path, upscale=2, arch='RestoreFromerPlusPlus', bg_upsampler=None, device=None,
        ...
        self.face_helper = FaceRestoreHelper(
            ...
            use_parse=True,
            device=self.device,
            model_rootpath=face_model_rootpath)
