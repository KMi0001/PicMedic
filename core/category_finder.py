...
CATEGORIES: dict[str, CategoryDef] = {
    "animal": CategoryDef(
        ...
        hint_text=(
            ...
            "놓치거나 잘못 찾은 사진이 있을 수 있어요. 행을 우클릭하면 미리보기/폴더 열기, 마음에 안 드는 사진을 다른 카테고리로 옮기기를 할 수 있어요."
        ),
...
# 사용자가 "다른 카테고리로 옮기기"로 직접 넣은 사진의 확신도 자리에 쓰는
# 표식값 — 실제 확신도(0~1)와 절대 겹치지 않고, 확신도 내림차순 정렬 시
# 맨 위로 온다. 화면에는 퍼센트 대신 "수동"으로 보인다.
MANUAL_CONFIDENCE = 2.0
